                    ...
                    <div className="flex-1">
                        <Tabs defaultValue="personal">
                            <TabsList className='w-full grid xl:grid-cols-3 xl:max-w-[520px] xl:border dark:border-none'>
                                ...
                                <TabsTrigger className='w-[162px] xl:w-auto' value='quanlifications'>Quanlifications</TabsTrigger>
                                        ...
                                        <div className="mb-16">
                                            ...
                                            <div>
                                                {getData(skillData, 'Skills').data.map((item, index) => {
                                                    ...
                                                    return (
                                                        <div className=" text-center xl:text-left mx-auto xl:mt-0" key={index}>
