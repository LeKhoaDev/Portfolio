        ...
        <section className="py-12 xl:py-24 h-[84vh] xl:pt-28 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none">
            <div className="container mx-auto">
                <div className="flex justify-between gap-x-8">
                    ...
                    <div className="flex max-w-[650px] flex-col justify-center xl:mt-0 text-center xl:text-left">
                        <div className="text-sm uppercase font-semibold mb-4 text-primary tracking-[4px]">Web Developer</div>
                        <h1 className="h1 mb-4">Hello, my name is Le Pham Anh Khoa</h1>
                        <p className="subtitle max-w-[490px] mx-auto xl:mx-0">
                            Brief decsription with insights into myself, my vocational journey,
